...
import com.lyc.jujiao.mapper.FriendsMapper;
import com.lyc.jujiao.model.entity.Friends;
...
import static com.lyc.jujiao.contant.FriendConstant.*;
...
public class FriendsServiceImpl extends ServiceImpl<FriendsMapper, Friends> implements FriendsService {
    ...
    public boolean agreeToApply(User loginUser, Long fromId) {
        ...
        collect.forEach(friend -> {
            ...
            // 1. 分别查询receiveId和fromId的用户，更改userIds（好友ids）中的数据
