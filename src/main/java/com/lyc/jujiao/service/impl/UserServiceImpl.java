package com.lyc.jujiao.service.impl;
...
import com.lyc.jujiao.mapper.UserMapper;
import com.lyc.jujiao.model.entity.User;
import com.lyc.jujiao.model.request.UpdateTagRequest;
import com.lyc.jujiao.model.request.UserQueryRequest;
import com.lyc.jujiao.model.request.UserUpdatePassword;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    public User getLoginUser(HttpServletRequest request) {
        ...
        Object objUser = request.getSession().getAttribute(LOGIN_USER_STATUS);
//        User currentUser = JSON.parseObject(objUser.toString(), User.class);
//        User currentUser = JSON.parseObject(String.valueOf(objUser), User.class);
                User currentUser = (User) objUser;
        if (currentUser == null) {
            throw new BusinessException(ErrorCode.NOT_LOGIN, "请先登录");
        }
