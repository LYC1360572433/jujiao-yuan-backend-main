package com.lyc.jujiao.ws;

import cn.hutool.core.date.DateUtil;
import cn.hutool.json.JSONObject;
import cn.hutool.json.JSONUtil;
import com.google.gson.Gson;
import com.lyc.jujiao.config.HttpSessionConfigurator;
import com.lyc.jujiao.model.entity.Chat;
import com.lyc.jujiao.model.entity.Team;
import com.lyc.jujiao.model.entity.User;
import com.lyc.jujiao.model.request.MessageRequest;
import com.lyc.jujiao.model.vo.MessageVo;
import com.lyc.jujiao.model.vo.WebSocketVo;
...
import static com.lyc.jujiao.contant.UserConstant.ADMIN_ROLE;
import static com.lyc.jujiao.contant.UserConstant.LOGIN_USER_STATUS;
import static com.lyc.jujiao.utils.StringUtils.stringJsonListToLongSet;
...
public class WebSocket {
    ...
    /**
     * 存储在线连接数（在线人数） String是userId,标识作用   存session和用户id
     */
    ...
    /**
     * 当建立socket连接时，将对应的session放进去，同步消息给所有session
     * @param session
     * @param userId
     * @param teamId
     * @param config
    ...
    public void onOpen(Session session, @PathParam(value = "userId") String userId, @PathParam(value = "teamId") String teamId, EndpointConfig config) {
        try {
            ...
            // 拿到存在httpSession里面的对象
            User user = (User) httpSession.getAttribute(LOGIN_USER_STATUS);
//            Object objUser = httpSession.getAttribute(LOGIN_USER_STATUS);
//            Object user = JSON.parseObject((byte[]) objUser, User.class);
            if (user != null) {
